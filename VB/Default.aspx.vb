...
Namespace S130793
	Partial Public Class _Default
		...
		Private Sub link2_CreateDetailArea(ByVal sender As Object, ByVal e As CreateAreaEventArgs)
			...
			tb.Rect = New RectangleF(0, 0, l.PrintingSystem.PageSettings.UsablePageSize.Width, 20)
			...
			tb.StringFormat = New BrickStringFormat(StringAlignment.Center)
			tb.Rect = New RectangleF(0, 20, l.PrintingSystem.PageSettings.UsablePageSize.Width, 20)
			tb.Sides = BorderSide.None
			e.Graph.DrawBrick(tb)
		End Sub
	End Class
